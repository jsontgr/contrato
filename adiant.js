...
function printContract2() {
    ...
    const adiant = document.getElementById('adiant').value;
    ...
    const contractContent2 = `
        ...
        <h3><p style="transform: translate(340px, -350px);"><strong>ADIANTAMENTO DE FRETE </strong></p></h3>
        ...
        PLACA:${placa}.
        <strong>ADIANTAMENTO: R$:${adiant}</strong>
        MOTORISTA:${mot}
        </p>
    ...
    newWindow.document.write(`<pre style="font-family: Arial; font-size: 20px;"> ${contractContent2}</pre>`);
